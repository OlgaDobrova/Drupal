...
<article";
  ...
  <div class=\"container\">
    <div class=\"about\">
      ...
      ";
        ...
        if ( !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, ($context["node"] ?? null), "field_image", [], "any", false, false, true, 25))) {
           ...
           ";
            // line 27
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_image", [], "any", false, false, true, 27), 0, [], "any", false, false, true, 27), "html", null, true);
            yield " 
          ";
            // line 29
            yield "        </div>
    ...
    {
        return array (  97 => 31,  93 => 29,  89 => 27,  86 => 26,  84 => 25,  81 => 24,  75 => 22,  73 => 21,  68 => 19,  58 => 14,  53 => 12,  51 => 11,  49 => 8,  48 => 7,  47 => 6,  46 => 5,  45 => 4,  44 => 2,);
    }
